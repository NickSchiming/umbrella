# Generated by Django 4.1.1 on 2022-10-31 22:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('aprovacao_pendente', 'Aprovação pendente'), ('aprovado', 'Aprovado'), ('recusado', 'Recusado'), ('enviado', 'Enviado'), ('finalizado', 'Finalizado')], max_length=50, null=True)),
                ('completo', models.BooleanField(default=False)),
                ('data', models.DateTimeField(auto_now_add=True, null=True, verbose_name='data do pedido')),
