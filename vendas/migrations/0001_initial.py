    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.CharField(blank=True, max_length=5, verbose_name='numero')),
                ('telefone', models.CharField(blank=True, max_length=30, verbose_name='telefone')),
                ('franquia', models.ForeignKey(blank=True, default=vendas.models.Loja.meta_diamante, null=True, on_delete=django.db.models.deletion.SET_NULL, to='vendas.franquia', verbose_name='franquia')),
            ],
        ),
        migrations.CreateModel(
            name='Meta',
        ...
        migrations.AddField(
            model_name='loja',
            name='meta',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='vendas.meta'),
        ),
        migrations.AddField(
            model_name='loja',
            name='user',
