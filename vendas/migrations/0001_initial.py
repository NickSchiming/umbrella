# Generated by Django 4.1.1 on 2022-10-21 15:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Produto',
            fields=[
                ('codigo', models.IntegerField(primary_key=True, serialize=False, verbose_name='codigo do pedido')),
        ...
        migrations.CreateModel(
            name='Pedido',
            fields=[
                ('cod_pedido', models.IntegerField(primary_key=True, serialize=False, verbose_name='código do pedido')),
                ...
                ('metodo_de_pagamento', models.CharField(blank=True, max_length=200)),
                ('franquia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='vendas.franquia', verbose_name='franquia')),
        ...
        migrations.CreateModel(
            name='Nota_fiscal',
            fields=[
                ('nf', models.IntegerField(primary_key=True, serialize=False, verbose_name='nota fiscal')),
