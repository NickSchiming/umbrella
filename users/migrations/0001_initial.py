    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('ADMIN', 'Admin'), ('REVENDEDOR', 'Revendedor'), ('LOJA', 'Loja'), ('SUPERVISOR', 'Supervisor'), ('FRANQUIA', 'Franquia')], default='ADMIN', max_length=50, verbose_name='type')),
